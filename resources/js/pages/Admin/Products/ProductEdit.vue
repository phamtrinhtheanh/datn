...
// Initialize selectedImages from product images
if (props.product.images) {
    const images = typeof props.product.images === 'string' ? JSON.parse(props.product.images) : props.product.images;
    selectedImages.value = images.map((url: string, index: number) => ({
...
const form = useForm({
    ...
    line_price: props.product.line_price || 0,
    import_price: props.product.import_price || 0,
    ...
    specs: typeof props.product.specs === 'string' ? props.product.specs : JSON.stringify(props.product.specs, null, 2),
    _method: 'PUT',
});
    ...
    <AppLayout>
        <div class="container mx-auto py-6">
            <div class="mb-6 flex items-start justify-between">
                <h1 class="mb-4 text-3xl font-extrabold">Chỉnh sửa sản phẩm</h1>
